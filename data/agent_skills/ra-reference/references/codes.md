...
Blockers: `ambiguous_slot`, `file_not_found`, `filename_id_not_found`, `no_target_for_file`, `path_already_managed`, `path_is_internal_state`, `path_outside_repository`, `slot_claimed_twice`, `slot_not_writable`, `slot_occupied`, `symlink_not_allowed`, `unknown_role`, `unknown_source_id`, `unsupported_new_source_type`, `url_ambiguous`, `url_not_found`

Warnings: `already_attached`, `duplicate_sha256`
...
`cell_not_a_url`, `column_without_prompt`, `duplicate_source_id`, `duplicate_url`, `empty_id_cell`, `mojibake_repaired`, `mojibake_unrepairable`, `no_header_row_found`, `no_prompts_row_found`, `no_sources_found`, `no_url_column_found`, `non_contiguous_ids`, `non_numeric_id`, `prompt_without_header`, `row_missing_url`
