...
def _gather(
    *,
    ...
    # cannot be a real article quoting one of these phrases.
    ...
    # Score, and record human-readable signals in the same pass.
    for phrase in dict.fromkeys(ev.strong_lead + ev.strong_body):
        ev.score += 3
