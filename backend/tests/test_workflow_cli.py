...
class CliContractTests(unittest.TestCase):
    ...
    def test_every_subcommand_is_registered(self) -> None:
        ...
        expected = {
            ...
            "convert", "images", "refresh-metadata", "triage", "retry", "attach",
            "run-column", "remap", "watch",
            # operator commands: data fixes + one-shot orchestration
            "config", "set-purpose", "profile", "set-cell", "set-fetch-status",
            "edit-column", "run-columns", "full-run",
        }
